...
typedef enum session_list_filter_flags { SL_NONE=0x0000 , SL_IO_OSBUF_NZ=0x0001 , SL_IO_EMPTY=0x0002, SL_TLS_DETAILS=0x0004, SL_ACTIVE=0x0010, SL_NO_NAMES=0x0020 } session_list_filter_flags_t;
