...
int cli_diag_mem_objects_stats(DiagCli *cli, const char *command, char *argv[], int argc) {
...
int cli_diag_mem_objects_list(DiagCli *cli, const char *command, char *argv[], int argc) {
...
int cli_diag_mem_objects_search(DiagCli *cli, const char *command, char *argv[], int argc) {
...
int cli_diag_mem_objects_clear(DiagCli *cli, const char *command, char *argv[], int argc) {
    ...
    if(argc > 0) {
        ...
        cli_print(cli, "Usage: diag mem objects clear <object-id>");
        return CLI_ERROR;
    }
...
void register_diags(libcli2::Cli& native) {
    ...
    auto diag_mem_objects = diag_register_command(cli, diag_mem, "objects", nullptr, PRIVILEGE_UNPRIVILEGED, MODE_EXEC, "memory object troubleshooting commands");
    diag_register_command(cli, diag_mem_objects, "stats", cli_diag_mem_objects_stats, PRIVILEGE_UNPRIVILEGED, MODE_EXEC, "memory objects statistics");
    diag_register_command(cli, diag_mem_objects, "list", cli_diag_mem_objects_list, PRIVILEGE_UNPRIVILEGED, MODE_EXEC, "memory objects list");
    diag_register_command(cli, diag_mem_objects, "search", cli_diag_mem_objects_search, PRIVILEGE_UNPRIVILEGED, MODE_EXEC, "memory objects search");
    diag_register_command(cli, diag_mem_objects, "clear", cli_diag_mem_objects_clear, PRIVILEGE_PRIVILEGED, MODE_EXEC, "clears memory object");
