...
CONFIG_MODE_DEF(cli_conf_edit_settings_webhook, MODE_EDIT_SETTINGS_WEBHOOK,"webhook")
CONFIG_MODE_DEF(cli_conf_edit_settings_admin, MODE_EDIT_SETTINGS_ADMIN,"admin")
